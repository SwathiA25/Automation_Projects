...
public class TC03_Automobile_Platinum {
	...
	public static void main(String[] args) throws AWTException, InterruptedException {
		...
		//Select Price option
		String expPrice = "1,362.00", expClaim = "Submit", expDis = "5", expCov = "Limited", actPrice, actClaim, actDis, actCov;
		...
		actCov = driver.findElement(By.xpath("//*[@id=\"priceTable\"]/tbody/tr[4]/td[4]")).getText();
