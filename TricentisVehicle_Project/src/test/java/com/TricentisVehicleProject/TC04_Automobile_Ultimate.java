...
public class TC04_Automobile_Ultimate {
	...
	public static void main(String[] args) throws AWTException, InterruptedException {
		...
		driver.findElement(By.id("licenseplatenumber")).sendKeys("KA02SA8956");
		...
		//Enter Product data
		driver.findElement(By.id("startdate")).sendKeys("01/10/2025");
		new Select(driver.findElement(By.id("insurancesum"))).selectByVisibleText(" 5.000.000,00");
		new Select(driver.findElement(By.id("meritrating"))).selectByVisibleText(" Bonus 4");
		...
		//Select Price option
		String expPrice = "2,595.00", expClaim = "Submit", expDis = "10", expCov = "Unlimited", actPrice, actClaim, actDis, actCov;
		...
		actCov = driver.findElement(By.xpath("//*[@id=\"priceTable\"]/tbody/tr[4]/td[5]")).getText();
