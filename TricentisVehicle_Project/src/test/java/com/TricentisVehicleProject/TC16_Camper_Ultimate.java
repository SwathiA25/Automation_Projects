...
public class TC16_Camper_Ultimate {
	...
	public static void main(String[] args) throws AWTException, InterruptedException {
		...
		//Enter Product data
		driver.findElement(By.id("startdate")).sendKeys("02/01/2025");
		...
		//Select Price option
		String expPrice = "3,086.00", expClaim = "Submit", expDis = "10", expCov = "Unlimited", actPrice, actClaim, actDis, actCov;
