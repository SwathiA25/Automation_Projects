...
public class TC12_Motorcycle_Ultimate {
	...
	public static void main(String[] args) throws AWTException, InterruptedException {
		...
		driver.findElement(By.id("dateofmanufacture")).sendKeys("01/01/2022");
		new Select(driver.findElement(By.id("numberofseatsmotorcycle"))).selectByValue("2");
		...
		//Enter Product data
		driver.findElement(By.id("startdate")).sendKeys("05/01/2025");
		...
		//Select Price option
		String expPrice = "2,621.00", expClaim = "Submit", expDis = "10", expCov = "Unlimited", actPrice, actClaim, actDis, actCov;
