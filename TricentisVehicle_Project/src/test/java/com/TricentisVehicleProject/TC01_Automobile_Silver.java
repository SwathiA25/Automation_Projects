...
public class TC01_Automobile_Silver {
	...
	public static void main(String[] args) throws AWTException, InterruptedException {
		...
		//Enter Product data
		driver.findElement(By.id("startdate")).sendKeys("01/10/2026");
		...
		//Select Price option
		String expPrice = "235.00", expClaim = "No", expDis = "No", expCov = "No", actPrice, actClaim, actDis, actCov;
